const CACHE='ctf-patch41-v1';
const ASSETS=['./','./index.html','./cards.html','./deckbuilder.html','./rules.html','./glossary.html','./play.html','./submit.html','./About_Us.html','./play_inline.js','./assets/js/data.js','./assets/js/deck-utils.js','./assets/js/engine.js','./manifest.json','./icon-ctf.svg'];
